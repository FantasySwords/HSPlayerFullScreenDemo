//
//  HSPlayerRotationViewWithLandscapeController.swift
...
class HSPlayerRotationViewWithLandscapeController: UIViewController {
    init() {
    ...
    func setupUI() {
        ...
        playerView = HSPlayerView4(playerContainerView: playerContainerView)
