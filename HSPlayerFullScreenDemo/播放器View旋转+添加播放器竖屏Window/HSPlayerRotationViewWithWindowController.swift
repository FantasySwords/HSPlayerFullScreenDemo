//
//  HSPlayerRotationViewWithWindowController.swift
...
class HSPlayerRotationViewWithWindowController: UIViewController {
    init() {
    ...
    func setupUI() {
        ...
        playerView = HSPlayerView3(playerContainerView: playerContainerView)
