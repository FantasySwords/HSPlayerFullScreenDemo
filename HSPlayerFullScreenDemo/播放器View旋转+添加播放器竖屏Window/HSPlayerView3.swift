...
class HSPlayerView3: UIView {
    ...
    deinit {
        ...
        self.playerSceneRootController = nil
...
extension HSPlayerView3 {
    ...
    func transitionToLandscape(orientation: UIInterfaceOrientation, animated: Bool) {
        ...
        if currentOrientation.isPortrait {
            ...
            playerSceneRootController?.interfaceOrientationMask = .portrait
        ...
        UIView.animateKeyframes(withDuration: duration, delay: 0, options: UIView.KeyframeAnimationOptions.layoutSubviews, animations: {
            ...
            self.playerSceneWindow?.addSubview(self.playerTransitionView)
